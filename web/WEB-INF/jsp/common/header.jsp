    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/flowers">Hoa</a>
                </li>
                <li class="nav-item">
                ...
                <c:choose>
                    ...
                    <c:when test="${not empty sessionScope.user}">
                        ...
                        <c:if test="${sessionScope.user.roleID == 2}">
                            <li class="nav-item">
                                <a class="nav-link" href="${pageContext.request.contextPath}/staff/orders">Quản lý đơn hàng</a>
                            </li>
                        </c:if>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <c:if test="${sessionScope.user.roleID == 3}">
                                    <li>
                                        <a class="dropdown-item" href="${pageContext.request.contextPath}/order-history">Đơn hàng của tôi</a>
                                    </li>
                                </c:if>
