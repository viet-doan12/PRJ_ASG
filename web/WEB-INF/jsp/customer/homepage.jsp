<%-- 
    Document   : homepage
    Created on : Jul 4, 2026, 7:34:55 PM
    Author     : ADMIN
--%>
        ...
        <div class="carousel-item" style="height: 400px; background-color: #fff3e0;">
            <div class="container h-100 d-flex align-items-center justify-content-center text-center">
                <div>
                    ...
                    <a href="${pageContext.request.contextPath}/flowers?categoryID=1" class="btn btn-warning text-white btn-lg rounded-pill px-5 shadow">Xem Mẫu</a>
                </div>
            </div>
        </div>
    </div>
